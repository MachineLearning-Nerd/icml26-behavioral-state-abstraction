...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_05027f6c9aa9", "created_at": "2026-07-29T12:06:48+00:00", "title": "Gate"}
-->
The fail-closed publication gate requires six passed claims, per-claim mechanism and control, source audit, and explicit theory-scope boundary.


---
<!-- trackio-cell
{"type": "code", "id": "cell_3fba3b496e92", "created_at": "2026-07-29T12:06:49+00:00", "title": "CPU verification and publication gate", "command": ["python3", "repro/src/verify.py"], "exit_code": 0, "duration_s": 0.077}
-->
````bash
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_365107756048", "created_at": "2026-07-29T12:06:51+00:00", "title": "Fail-closed gate", "command": ["python3", "repro/src/publication_gate.py"], "exit_code": 0, "duration_s": 0.106}
-->
````bash
